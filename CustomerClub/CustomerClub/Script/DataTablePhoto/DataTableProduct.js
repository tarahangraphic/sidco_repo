function DataTableProduct(ListData, colums, Content, buttons, option,dotbutton) {
    ...
    for (var i in ListData) {
        ...
        if (dotbutton != null) {
            for (var k in dotbutton) {
                trdotbutton += '<li><button id=' + k + ' type="button" class="' + dotbutton[k].class + '"><span class="fa fa-' + dotbutton[k].Icon + '"></span>&nbsp;&nbsp;' + dotbutton[k].Text + '</button></li>';
            }
