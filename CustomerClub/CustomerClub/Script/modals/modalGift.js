var error_state_Gift = false;
function creatmodalGift(Content) {
...
function creatformGift(content, listtag, listbuttons, title) {
...
function creattagGift(type, title, name, event) {
    ...
    if (name =='MinPoint') {
        tag = '<input type="' + type + '" class="form-control numericOnly" data-display="' + title + '" name= "' + name + '" id= "' + name + '"  placeholder= "' + title + ' را وارد کنید " >';
    }
    var str1 = "";
    if (error_state_Gift == false) {
