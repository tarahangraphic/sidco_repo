function DataTableUsers(ListData, colums, Content, buttons, option, dotbutton) {
    if (ListData == null || ListData.length == 0) {
        $(divUser).fadeOut();
        $(divuserrequest).fadeIn();
    }
    var _table = '<table class="table table-striped table-border table-hover table-responsive datatable-example"><thead><tr>';
