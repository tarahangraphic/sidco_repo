var _listnaem = [];
function DataTableServices(ListData, colums, Content, option, buttons) {
    ...
    for (var i in ListData) {
        ...
        for (var j in colums) {
            ...
            if (colums[j].Data == "Url") {
                trtd += '<td><img class="avatar img-circle" style="width:40px;height:30px;cursor:pointer;" src="../img/services/' + ListData[i][colums[j].Data] + '" /></td>';
            }
            if (colums[j].Data == "Url") {
                continue;
            }
