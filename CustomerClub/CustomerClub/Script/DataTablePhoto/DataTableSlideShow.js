var _listnaem = [];
function DataTableSlideShow(ListData, colums, Content, option, buttons) {
    ...
    for (var i in ListData) {
        ...
        for (var j in colums) {
            ...
            if (colums[j].Data == "Image") {
                trtd += '<td><img class="avatar img-circle" style="width:40px;height:30px;cursor:pointer;" src="../img/slideshow/' + ListData[i][colums[j].Data] + '" /></td>';
